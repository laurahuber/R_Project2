...
### Exercise 1:
Cyclicity of an epidemics can be explained by many factors. Here, we can see that by changing contacts bewteen differen age groups, we alterate the cyclicity of the epidemics. 
...
###################################################
load('data (2).RData')    #load the data
